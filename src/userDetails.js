...
export default function UserDetails(props) {
  ...
  const [filteredActivityData, setfilteredData] = React.useState(
    selectedUsersActivity
  );
    ...
    <div>
      <Modal open={open} onClose={() => setOpen(!open)}>
        ...
        >
          ...
          />
          <Timeline align="alternate">{getSessions()}</Timeline>
          <div
            style={{
          ...
          >
            <h2 id="simple-modal-title" align="center">
              No Activity on the selected Date:{" "}
            </h2>
          </div>
        </div>
      </Modal>
